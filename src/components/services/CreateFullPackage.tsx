...
const CreateServicePackage = ({ isOpen, setIsOpen }: any) => {
      ...
      <DialogContent className="max-w-lg overflow-y-auto max-h-screen">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Button
              type="button"
              className="py-2 px-5 rounded-full font-semibold bg-transparent text-sky-500"
              onClick={() =>
                setFormData((prev: any) => ({
                  ...prev,
                  details: [...prev.details, { description: "" }],
                }))
              }
            >
              + Add Detail
            ...
            {formData.details.map((detail: any, index: number) => (
              <div key={index} className="flex gap-2 mb-2">
                <Input
                  ...
                  onChange={(e) => {
                    const updatedDetails = [...formData.details] as any;
