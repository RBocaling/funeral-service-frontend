...
const ViewServiceFullPackage = ({
  ...
  const filterData = data?.filter((item: any) => item.serviceType === "FULL_PACKAGE");
 ...
 >
   <DialogContent className="sm:max-w-[1100px] p-0 rounded-2xl overflow-hidden">
     <div className="relative bg-transparent bg-gray-100 dark:bg-gray-800">
       <h2 className="text-xl font-semibold mb-2 p-3">{serviceType}</h2>
       <Button
         variant="ghost"
         size="icon"
...
export default ViewServiceFullPackage;
